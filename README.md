...
* **Pre-requisitos:** Antes de todo, para rodar esse projeto é necessario que você tenha já tenha o [node js](https://nodejs.org/en/), e o [yarn](https://yarnpkg.com/pt-BR/).
